...
export const JobsCategory = () => {
    return (
        <div class="w-full py-4 bg-white mb-10">
            ...
            <div class="grid grid-cols-3 gap-2">
                <div class="mt-2 text-base col-span-2 ml-2">Hard of Hearing</div>
                <div class="ml-8 mt-2">
                    <button class="bg-violet-200 text-indigo-700 font-bold px-3 py-1 rounded-full">
                        320
                    </button></div>
            ...
            <div class="grid grid-cols-3 gap-2">
                <div class="mt-2 text-base col-span-2 ml-6">Wheelchair Bound</div>
                <div class="ml-8 mt-2">
                    <button class="bg-violet-200 text-indigo-700 font-bold px-3 py-1 rounded-full">
                        320
                    </button></div>
            ...
            <div class="grid grid-cols-3 gap-2">
                <div class="mt-2 text-base col-span-2 ml-1">Dumb and Deaf</div>
                <div class="ml-8 mt-2">
                    <button class="bg-violet-200 text-indigo-700 font-bold px-3 py-1 rounded-full">
                        320
                    </button></div>
